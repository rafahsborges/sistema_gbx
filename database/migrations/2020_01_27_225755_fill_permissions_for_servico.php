...
class FillPermissionsForServico extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForServico constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.servico',
            'admin.servico.index',
            'admin.servico.create',
            'admin.servico.show',
            'admin.servico.edit',
            'admin.servico.delete',
            'admin.servico.bulk-delete',
        ]);
