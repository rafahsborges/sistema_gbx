...
class FillPermissionsForInformativo extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForInformativo constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.informativo',
            'admin.informativo.index',
            'admin.informativo.create',
            'admin.informativo.show',
            'admin.informativo.edit',
            'admin.informativo.delete',
            'admin.informativo.bulk-delete',
        ]);
