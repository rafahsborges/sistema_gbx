...
class FillPermissionsForOrcamento extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForOrcamento constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            ...
            'admin.orcamento.show',
            'admin.orcamento.edit',
            'admin.orcamento.delete',
            'admin.orcamento.bulk-delete',
        ]);
