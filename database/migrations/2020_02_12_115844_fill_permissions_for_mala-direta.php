...
class FillPermissionsForMalaDireta extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForMalaDireta constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.mala-direta',
            'admin.mala-direta.index',
            'admin.mala-direta.create',
            'admin.mala-direta.show',
            'admin.mala-direta.edit',
            'admin.mala-direta.delete',
            'admin.mala-direta.bulk-delete',
        ]);
