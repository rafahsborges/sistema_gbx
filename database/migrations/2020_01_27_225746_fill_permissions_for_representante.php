...
class FillPermissionsForRepresentante extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForRepresentante constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.representante',
            'admin.representante.index',
            'admin.representante.create',
            'admin.representante.show',
            'admin.representante.edit',
            'admin.representante.delete',
            'admin.representante.bulk-delete',
        ]);
