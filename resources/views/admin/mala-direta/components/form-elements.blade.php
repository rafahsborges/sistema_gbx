<div class="form-group row align-items-center"
    ...
    <label for="assunto" class="col-form-label text-md-right"
           :class="isFormLocalized ? 'col-md-4' : 'col-md-2'">{{ trans('admin.mala-direta.columns.assunto') }}</label>
    <div :class="isFormLocalized ? 'col-md-4' : 'col-md-9 col-xl-8'">
        <input type="text" v-model="form.assunto" v-validate="'required'" @input="validate($event)" class="form-control"
               ...
               id="assunto" name="assunto" placeholder="{{ trans('admin.mala-direta.columns.assunto') }}">
...
<div class="form-group row align-items-center"
    ...
    <label for="conteudo" class="col-form-label text-md-right"
           :class="isFormLocalized ? 'col-md-4' : 'col-md-2'">{{ trans('admin.mala-direta.columns.conteudo') }}</label>
    <div :class="isFormLocalized ? 'col-md-4' : 'col-md-9 col-xl-8'">
        <div>
