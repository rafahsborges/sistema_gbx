<div class="form-group row align-items-center"
    ...
    <div :class="isFormLocalized ? 'col-md-4' : 'col-md-9 col-xl-8'">
        <input type="text" v-model="form.nome" v-validate="'required'" @input="validate($event)" class="form-control"
               ...
               id="nome" name="nome" placeholder="{{ trans('admin.item.columns.nome') }}">
...
<div class="form-group row align-items-center"
    ...
    <label for="id_etapa" class="col-form-label text-md-right"
           :class="isFormLocalized ? 'col-md-4' : 'col-md-2'">{{ trans('admin.item.columns.id_etapa') }}</label>
    <div :class="isFormLocalized ? 'col-md-4' : 'col-md-9 col-xl-8'">
        <multiselect
            v-model="form.etapa"
            :options="etapas"
        ...
        <div v-if="errors.has('id_etapa')" class="form-control-feedback form-text" v-cloak>@{{ errors.first('id_etapa')
            }}
        </div>
    </div>
</div>
