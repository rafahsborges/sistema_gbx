...
<div class="form-group row align-items-center" :class="{'has-danger': errors.has('id_etapa'), 'has-success': fields.id_etapa && fields.id_etapa.valid }">
    <label for="id_etapa" class="col-form-label text-md-right" :class="isFormLocalized ? 'col-md-4' : 'col-md-2'">{{ trans('admin.item.columns.id_etapa') }}</label>
        <div :class="isFormLocalized ? 'col-md-4' : 'col-md-9 col-xl-8'">
        <input type="text" v-model="form.id_etapa" v-validate="'required'" @input="validate($event)" class="form-control" :class="{'form-control-danger': errors.has('id_etapa'), 'form-control-success': fields.id_etapa && fields.id_etapa.valid}" id="id_etapa" name="id_etapa" placeholder="{{ trans('admin.item.columns.id_etapa') }}">
...
<div class="form-group row align-items-center" :class="{'has-danger': errors.has('id_status'), 'has-success': fields.id_status && fields.id_status.valid }">
    <label for="id_status" class="col-form-label text-md-right" :class="isFormLocalized ? 'col-md-4' : 'col-md-2'">{{ trans('admin.item.columns.id_status') }}</label>
        <div :class="isFormLocalized ? 'col-md-4' : 'col-md-9 col-xl-8'">
        <input type="text" v-model="form.id_status" v-validate="'required'" @input="validate($event)" class="form-control" :class="{'form-control-danger': errors.has('id_status'), 'form-control-success': fields.id_status && fields.id_status.valid}" id="id_status" name="id_status" placeholder="{{ trans('admin.item.columns.id_status') }}">
