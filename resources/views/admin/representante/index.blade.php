                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <a class="btn btn-primary btn-spinner btn-sm pull-right m-b-0"
                           href="{{ url('admin/representantes/create') }}" role="button"><i class="fa fa-plus"></i>&nbsp; {{ trans('admin.representante.actions.create') }}
                        </a>
                    </div>
                        ...
                        <div class="card-block">
                            ...
                            <table class="table table-hover table-listing">
                                ...
                                <tr>
                                    ...
                                    <th is='sortable'
                                        :column="'nome'">{{ trans('admin.representante.columns.nome') }}</th>
                                    <th is='sortable'
                                        :column="'email'">{{ trans('admin.representante.columns.email') }}</th>
                                    <th is='sortable'
                                        :column="'telefone'">{{ trans('admin.representante.columns.telefone') }}</th>
                                    <th is='sortable'
                                        :column="'celular'">{{ trans('admin.representante.columns.celular') }}</th>
                                    <th is='sortable'
                                        :column="'cargo'">{{ trans('admin.representante.columns.cargo') }}</th>
                                    <th is='sortable'
                                        :column="'id_cliente'">{{ trans('admin.representante.columns.id_cliente') }}</th>
                                ...
                                <tr v-show="(clickedBulkItemsCount > 0) || isClickedAll">
                                    <td class="bg-bulk-info d-table-cell text-center" colspan="9">
                                            <span class="align-middle font-weight-light text-dark">{{ trans('brackets/admin-ui::admin.listing.selected_items') }} @{{ clickedBulkItemsCount }}.  <a
                                                    ...
                                                    @click="onBulkItemsClickedAll('/admin/representantes')"
                                        ...
                                        <span class="pull-right pr-2">
                                                <button class="btn btn-sm btn-danger pr-3 pl-3"
                                                        @click="bulkDelete('/admin/representantes/bulk-destroy')">{{ trans('brackets/admin-ui::admin.btn.delete') }}</button>
                                            </span>
                            ...
                            <div class="no-items-found" v-if="!collection.length > 0">
                                ...
                                <a class="btn btn-primary btn-spinner" href="{{ url('admin/representantes/create') }}"
                                   role="button"><i
                                        class="fa fa-plus"></i>&nbsp; {{ trans('admin.representante.actions.create') }}
                                </a>
                            </div>
                        </div>
                    </div>
