                    ...
                    <div class="card-body" v-cloak>
                        ...
                        <table class="table table-hover table-listing">
                            ...
                            <tr>
                                ...
                                <th is='sortable'
                                    :column="'razao_social'">{{ trans('admin.admin-user.columns.razao_social') }}</th>
                                ...
                                <th is='sortable'
                                    :column="'enabled'">{{ trans('admin.admin-user.columns.enabled') }}</th>
                                <th></th>
                            </tr>
                            </thead>
                            <tbody>
                            <tr v-for="(item, index) in collection">
                                ...
                                <td>
                                    <label class="switch switch-3d switch-success">
                                        <input type="checkbox" class="switch-input" v-model="collection[index].enabled"
