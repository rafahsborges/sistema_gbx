    ...
    <div class="card-block">
        ...
        <div class="form-group row align-items-center"
            ...
            <div :class="isFormLocalized ? 'col-md-4' : 'col-md-9 col-xl-8'">
                ...
                <div v-if="errors.has('tipo')" class="form-control-feedback form-text" v-cloak>@{{ errors.first('tipo')
                    }}
                </div>
            </div>
        </div>
        ...
        <div class="form-group row align-items-center"
            ...
            <div :class="isFormLocalized ? 'col-md-4' : 'col-md-9 col-xl-8'">
                ...
                <div v-if="errors.has('email2')" class="form-control-feedback form-text" v-cloak>@{{
                    errors.first('email2') }}
                </div>
            </div>
        </div>
        ...
        <div class="form-group row align-items-center"
            ...
            <div :class="isFormLocalized ? 'col-md-4' : 'col-md-9 col-xl-8'">
                ...
                <div v-if="errors.has('email3')" class="form-control-feedback form-text" v-cloak>@{{
                    errors.first('email3') }}
                </div>
            </div>
        </div>
        ...
        <div class="form-group row align-items-center"
            ...
            <div :class="isFormLocalized ? 'col-md-4' : 'col-md-9 col-xl-8'">
                <input type="text" v-model="form.telefone" v-validate="''" @input="validate($event)"
                       class="form-control" v-mask="'(##) ####-####'"
        ...
        <div class="form-group row align-items-center"
            ...
            <div :class="isFormLocalized ? 'col-md-4' : 'col-md-9 col-xl-8'">
                <input type="text" v-model="form.logradouro" v-validate="''" @input="validate($event)"
                       class="form-control"
        ...
        <div class="form-group row align-items-center"
            ...
            <div :class="isFormLocalized ? 'col-md-4' : 'col-md-9 col-xl-8'">
                ...
                <div v-if="errors.has('numero')" class="form-control-feedback form-text" v-cloak>@{{
                    errors.first('numero') }}
                </div>
            </div>
        </div>
        ...
        <div class="form-group row align-items-center"
            ...
            <div :class="isFormLocalized ? 'col-md-4' : 'col-md-9 col-xl-8'">
                <input type="text" v-model="form.complemento" v-validate="''" @input="validate($event)"
                       class="form-control"
        ...
        <div class="form-group row align-items-center"
            ...
            <div :class="isFormLocalized ? 'col-md-4' : 'col-md-9 col-xl-8'">
                ...
                <div v-if="errors.has('bairro')" class="form-control-feedback form-text" v-cloak>@{{
                    errors.first('bairro') }}
                </div>
            </div>
        </div>
        ...
        <div class="form-group row align-items-center"
            ...
            <label for="cidade" class="col-form-label text-md-right"
                   :class="isFormLocalized ? 'col-md-4' : 'col-md-2'">{{ trans('admin.admin-user.columns.cidade') }}</label>
            <div :class="isFormLocalized ? 'col-md-4' : 'col-md-9 col-xl-8'">
                <input type="text" v-model="form.cidade" v-validate="''" @input="validate($event)" class="form-control"
                       ...
                       id="cidade" name="cidade" placeholder="{{ trans('admin.admin-user.columns.cidade') }}">
                <div v-if="errors.has('cidade')" class="form-control-feedback form-text" v-cloak>@{{
                    errors.first('cidade') }}
                </div>
            </div>
        </div>
        ...
        <div class="form-group row align-items-center"
            ...
            <label for="uf" class="col-form-label text-md-right"
                   :class="isFormLocalized ? 'col-md-4' : 'col-md-2'">{{ trans('admin.admin-user.columns.uf') }}</label>
            <div :class="isFormLocalized ? 'col-md-4' : 'col-md-9 col-xl-8'">
                <multiselect
                    v-model="form.uf"
                    :options="ufList"
                    ...
                    track-by="id"
                    label="nome"
                    tag-placeholder="{{ trans('admin.admin-user.columns.uf') }}"
                    placeholder="{{ trans('admin.admin-user.columns.uf') }}">
                </multiselect>
                <div v-if="errors.has('uf')" class="form-control-feedback form-text" v-cloak>@{{ errors.first('uf') }}
                </div>
            </div>
        </div>
        ...
        <div class="form-group row align-items-center"
            ...
            <div :class="isFormLocalized ? 'col-md-4' : 'col-md-9 col-xl-8'">
                ...
                <div v-if="errors.has('cep')" class="form-control-feedback form-text" v-cloak>@{{ errors.first('cep')
                    }}
                </div>
            </div>
        </div>
        ...
        <div class="form-group row align-items-center"
            ...
            <div :class="isFormLocalized ? 'col-md-4' : 'col-md-9 col-xl-8'">
                <input type="text" v-model="form.valor" v-validate="'decimal'" @input="validate($event)"
                       class="form-control"
        ...
        <div class="form-group row align-items-center"
            ...
            <div :class="isFormLocalized ? 'col-md-4' : 'col-md-9 col-xl-8'">
                ...
                <div v-if="errors.has('fistel')" class="form-control-feedback form-text" v-cloak>@{{
                    errors.first('fistel') }}
                </div>
            </div>
        </div>
        ...
        <div class="form-group row align-items-center"
            ...
            <div :class="isFormLocalized ? 'col-md-4' : 'col-md-9 col-xl-8'">
                ...
                <div v-if="errors.has('roles')" class="form-control-feedback form-text" v-cloak>@{{
                    errors.first('roles') }}
                </div>
            </div>
        </div>
        ...
        <div class="form-group row align-items-center"
            ...
            <div :class="isFormLocalized ? 'col-md-4' : 'col-md-9 col-xl-8'">
                ...
                <div v-if="errors.has('is_admin')" class="form-control-feedback form-text" v-cloak>@{{
