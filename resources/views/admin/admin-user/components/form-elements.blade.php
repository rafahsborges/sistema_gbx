...
<div class="form-group row align-items-center"
    ...
    <div :class="isFormLocalized ? 'col-md-4' : 'col-md-9 col-xl-8'">
        <input type="text" v-model="form.numero" :maxlength="15" v-validate="''" @input="validate($event)"
               class="form-control"
...
<div class="form-group row align-items-center"
    ...
    <div :class="isFormLocalized ? 'col-md-4' : 'col-md-9 col-xl-8'">
        <input type="text" v-model="form.fistel" :maxlength="11" v-validate="''" @input="validate($event)"
               class="form-control"
