    ...
    <div class="card-body">
        ...
        <div v-for="(row, index) in form.pontos">
            ...
            <div class="form-group row align-items-center"
                ...
                <div :class="isFormLocalized ? 'col-md-4' : 'col-md-9 col-xl-8'">
                    <input type="text" v-model="row.logradouro" v-validate="''" @input="validate($event)"
                           class="form-control"
                           ...
                           placeholder="{{ trans('admin.ponto.columns.logradouro') }}">
            ...
            <div class="form-group row align-items-center"
                ...
                <div :class="isFormLocalized ? 'col-md-4' : 'col-md-9 col-xl-8'">
                    <input type="text" v-model="row.numero" v-validate="''" @input="validate($event)"
                           class="form-control"
            ...
            <div class="form-group row align-items-center"
                ...
                <div :class="isFormLocalized ? 'col-md-4' : 'col-md-9 col-xl-8'">
                    <input type="text" v-model="row.complemento" v-validate="''" @input="validate($event)"
                           class="form-control"
                           :class="{'form-control-danger': errors.has('complemento'), 'form-control-success': fields.complemento && fields.complemento.valid}"
                           id="complemento" name="complemento"
                           placeholder="{{ trans('admin.ponto.columns.complemento') }}">
            ...
            <div class="form-group row align-items-center"
                ...
                <div :class="isFormLocalized ? 'col-md-4' : 'col-md-9 col-xl-8'">
                    <input type="text" v-model="row.bairro" v-validate="''" @input="validate($event)"
                           class="form-control"
            ...
            <div class="form-group row align-items-center"
                ...
                <div :class="isFormLocalized ? 'col-md-4' : 'col-md-9 col-xl-8'">
                    <input type="text" v-model="row.estacao" v-validate="''" @input="validate($event)"
                           class="form-control"
                    ...
                    <div v-if="errors.has('estacao')" class="form-control-feedback form-text" v-cloak>@{{
                        errors.first('estacao')
                        }}
                    </div>
                </div>
            </div>
            ...
            <div class="form-group row align-items-center"
                ...
                <div :class="isFormLocalized ? 'col-md-4' : 'col-md-9 col-xl-8'">
                    <input type="text" v-model="row.entidade" v-validate="''" @input="validate($event)"
                           class="form-control"
                    ...
                    <div v-if="errors.has('entidade')" class="form-control-feedback form-text" v-cloak>@{{
            ...
            <div class="form-group row align-items-center"
                ...
                <div :class="isFormLocalized ? 'col-md-4' : 'col-md-9 col-xl-8'">
                    <input type="text" v-model="row.latitude" v-validate="''" @input="validate($event)"
                           class="form-control"
                    ...
                    <div v-if="errors.has('latitude')" class="form-control-feedback form-text" v-cloak>@{{
            ...
            <div class="form-group row align-items-center"
                ...
                <div :class="isFormLocalized ? 'col-md-4' : 'col-md-9 col-xl-8'">
                    <input type="text" v-model="row.longitude" v-validate="''" @input="validate($event)"
                           class="form-control"
            ...
            <div class="form-group row align-items-center"
                ...
                <div :class="isFormLocalized ? 'col-md-4' : 'col-md-9 col-xl-8'">
                    <input type="text" v-model="row.altura" v-validate="''" @input="validate($event)"
                           class="form-control"
                    ...
                    <div v-if="errors.has('altura')" class="form-control-feedback form-text" v-cloak>@{{
                        errors.first('altura') }}
                    </div>
                </div>
            </div>
