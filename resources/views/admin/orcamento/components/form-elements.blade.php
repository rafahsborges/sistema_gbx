<div class="form-group row align-items-center"
    ...
    <label for="tipo" class="col-form-label text-md-right"
           :class="isFormLocalized ? 'col-md-4' : 'col-md-2'">{{ trans('admin.orcamento.columns.tipo') }}</label>
    ...
    <div class="form-group row align-items-center"
        ...
        <div :class="isFormLocalized ? 'col-md-4' : 'col-md-9 col-xl-8'">
            <input type="text" v-model="form.razao_social" v-validate="''" @input="validate($event)"
                   ...
                   placeholder="{{ trans('admin.orcamento.columns.razao_social') }}">
...
<div class="form-group row align-items-center"
    ...
    <div :class="isFormLocalized ? 'col-md-4' : 'col-md-9 col-xl-8'">
        <multiselect
            ...
            track-by="id"
            label="nome"
            tag-placeholder="{{ trans('admin.orcamento.columns.id_cidade') }}"
            placeholder="{{ trans('admin.orcamento.columns.id_cidade') }}">
        </multiselect>
...
<div class="form-group row align-items-center"
    ...
    <div :class="isFormLocalized ? 'col-md-4' : 'col-md-9 col-xl-8'">
        <multiselect
            ...
            track-by="id"
            label="nome"
            tag-placeholder="{{ trans('admin.orcamento.columns.id_estado') }}"
            placeholder="{{ trans('admin.orcamento.columns.id_estado') }}">
        </multiselect>
...
<div class="form-check row" v-if="form.enviar === false || form.enviar === 0"
