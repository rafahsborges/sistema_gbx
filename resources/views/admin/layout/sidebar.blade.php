<div class="sidebar">
    <nav class="sidebar-nav">
        <ul class="nav">
            ...
            <li class="nav-item"><a class="nav-link" href="{{ url('admin/estados') }}"><i class="nav-icon icon-diamond"></i> {{ trans('admin.estado.title') }}</a></li>
           <li class="nav-item"><a class="nav-link" href="{{ url('admin/cidades') }}"><i class="nav-icon icon-drop"></i> {{ trans('admin.cidade.title') }}</a></li>
